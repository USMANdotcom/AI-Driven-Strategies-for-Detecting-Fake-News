...
Welcome to the Fake News Detector project! This project was created as part of my university coursework, and I'm excited to share it with the developer community. If you are interested in contributing to this project or using it as a basis for your own development, please read on.
...
`git clone https://github.com/USMANdotcom/AI-Driven-Strategies-for-Detecting-Fake-News`

2. Install the required libraries for python

`cd AI-Driven-Strategies-for-Detecting-Fake-News/app/FakeNewsDetectorAPI/ && pip install -r requirements.txt`
